    ...
    <div id="templatemo_main">
        ...
        <div id="templatemo_content">
         ...
         <table width="576" border="1">
              <tr>
                <td width="152"><p><a href='employee.php?editemp=<?php //Developed by www.freestudentprojects.com echo $_SESSION[pmagid]; ?>'><img src="images/profile.jpg" width="150" height="152" /></a></p>
                <p><strong><a href='employee.php?editemp=<?php //Developed by www.freestudentprojects.com echo $_SESSION[pmagid]; ?>'>Edit Profile</a></strong></p></td>
                ...
                <td width="152" align="center" valign="middle"><p><a href='viewproject.php'><img src="images/projstat.jpg" width="150" height="152" /></a></p>
