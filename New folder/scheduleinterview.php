...
<input type="date" name="fromdate" value="<?php //Developed by www.freestudentprojects.com echo  date('Y-m-d',strtotime($res[interviewfdate])); ?>" />
<input name="fromtime" type="time" id="fromtime" value="<?php //Developed by www.freestudentprojects.com echo date('h:i', strtotime($res[interviewfdate])); ?>" /></tr>
<tr>
  <th align="left">&nbsp;To 
  <th align="left"><input type="date" name="todate" value="<?php //Developed by www.freestudentprojects.com echo  date('Y-m-d',strtotime($res[interviewtdate])); ?>" />
    <input name="totime" type="time" id="totime"  value="<?php //Developed by www.freestudentprojects.com echo date('h:i', strtotime($res[interviewtdate])); ?>" />  
  </tr>
...
<td> From: " . date('d-m-Y h:i A', strtotime($res[interviewfdate]));  
echo "<br> To: $rs[interviewtdate]</td>
<td>$rs[venue]<br>Contact No. $rs[contactno]</td><td>$rs[status]</td>
<td><a href='scheduleinterview.php?editint=$rs[vacid]'>Edit</a>|
